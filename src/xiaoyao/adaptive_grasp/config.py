...
class AdaptiveGraspConfig:
    ...
    pre_grasp_pose: dict[JointId, float] = field(default_factory=dict)  # Joint target pose in radians before closing.
    ...
    position_hold_max_step_rad: float = math.radians(4)  # Maximum total joint-angle correction per control cycle.
