...
from xiaoyao.adaptive_grasp.pid_controller import PidController, PidParams


PID_CONTROLLER_SOURCE = (
    Path(__file__).parents[2] / "src" / "xiaoyao" / "adaptive_grasp" / "pid_controller.py"
)


def test_pid_controller_exports_from_adaptive_grasp_package():
    from xiaoyao.adaptive_grasp import PidController as ExportedPidController
    from xiaoyao.adaptive_grasp import PidParams as ExportedPidParams
