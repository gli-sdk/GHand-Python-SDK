...
def main():
    ...
    try:
        ...
        while True:
            ...
            joints.append(Joint(id=JointId.THUMB_PIP, angle=math.radians(30), speed=1000, torque=90))   #角度范围为:0~75(度)
            joints.append(Joint(id=JointId.THUMB_MCP, angle=math.radians(30), speed=1000, torque=90))   #角度范围为:0~55(度)
