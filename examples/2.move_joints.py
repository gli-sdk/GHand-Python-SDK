...
def main():
    ...
    try:
        ...
        while True:
            ...
            joints.append(Joint(id=JointId.THUMB_ROTATION, angle=math.radians(-30), speed=100, torque=100))
            ...
            joints.append(Joint(id=JointId.FF_SWING, angle=math.radians(30), speed=100, torque=100))
