...
def main():
    ...
    try:
        ...
        print("--- 测试：检测碰撞并规避 ---")
        target_joints = [
            Joint(id=JointId.THUMB_PIP, angle=math.radians(66)),
            Joint(id=JointId.THUMB_SWING, angle=math.radians(52)),
            Joint(id=JointId.THUMB_ROTATION, angle=math.radians(-10)),
            Joint(id=JointId.FF_PIP, angle=math.radians(70)),
            Joint(id=JointId.FF_MCP, angle=math.radians(70)),
        ]
